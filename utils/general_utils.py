...
def get_total_iteration_count(data_count, world_size, epochs, batch_size, accum_steps = 2):
  num_iteration_per_epoch = (data_count // world_size) // (batch_size * accum_steps)
